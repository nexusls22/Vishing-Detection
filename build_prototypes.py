"""
Computes the bonafide/spoof prototype vectors (normalised mean of the training
embeddings) and saves them, with the EER threshold, to src/models/prototypes.pt
for the Gradio app. Run once before launching the app.
"""
...
# Full (unbalanced) training set, matching reconstruct_eer.py.
...
# Per-class normalised mean embedding, approximating the AAM-Softmax weights.
